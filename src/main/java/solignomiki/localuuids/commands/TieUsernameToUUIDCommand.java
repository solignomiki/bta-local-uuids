...
public class TieUsernameToUUIDCommand implements CommandManager.CommandRegistry {
	...
	private static final SimpleCommandExceptionType INVALID_UUID = new SimpleCommandExceptionType(() -> {
		return I18n.getInstance().translateKey("localuuids.invalid_uuid");
	});

	public TieUsernameToUUIDCommand() {

	}

	public void register(CommandDispatcher<CommandSource> dispatcher) {
		dispatcher.register((LiteralArgumentBuilder<CommandSource>) (Object) LiteralArgumentBuilder.literal("tieusernametouuid")
